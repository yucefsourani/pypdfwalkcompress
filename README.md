...
# help
```
usage: pypdfwalkcompress.py [-h] [-v] [-t Reduce PDF Size Type (image|compression) ,Default image.] -l Folder|File Location
                            [-q Quality range 1--->100 ,Default 80'(%)'] [-r]

Script To Reduce PDF Files Size.
